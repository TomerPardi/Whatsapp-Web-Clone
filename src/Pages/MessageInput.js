  ...
  function handleLoc() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition((position) => {
        ...
        const url = `https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/pin-s+ff0000(${long},${lat})/${long},${lat},15.01,0/200x200@2x?access_token=pk.eyJ1IjoiZnVua2V5N2RhbiIsImEiOiJjbDIwNm13enMwN2tkM3BxNDZjNGRkNDF2In0.DOuTKK-wNrsod_08yK1LWA`;
        ...
        >
          ...
          {existingRecord && (
            <div className='recorderForm'>
              <audio
                className='recorderForm col align-self-stretch'
                src={audioURL}
                controls
                id='player'
              ></audio>
